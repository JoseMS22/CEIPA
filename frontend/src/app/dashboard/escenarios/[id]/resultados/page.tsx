...
export default function ScenarioResultsPage() {
  ...
  // ---- datos adaptados para los componentes ----
  ...
  return (
    <div className="min-h-screen bg-[#E9EAED]">
      ...
      <header className="border-b bg-[#E9EAED]">
        <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-0 py-3 sm:py-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <h1 className="text-xl sm:text-2xl font-semibold text-[#0E1F36]">
            Resultados {scenario ? `– ${scenario.name}` : ""}
          </h1>
      ...
      <main className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-0 py-6 space-y-8">
        {loading ? (
          <p className="text-sm text-zinc-500">Cargando resultados...</p>
        ) : usedCountryIds.length === 0 ? (
          <p className="text-sm text-zinc-500">
            Este escenario aún no tiene valores cargados.
          </p>
        ) : (
          <>
            {/* Índice ponderado por entorno */}
            <section>
              <h2 className="text-base sm:text-lg font-semibold text-[#0E1F36] mb-2">
                Índice ponderado por entorno
              </h2>
              <div className="rounded-3xl bg-white shadow p-3 sm:p-4">
            ...
            <section>
              ...
              <div className="rounded-3xl bg-white shadow p-3 sm:p-4">
                {/* El tamaño lo controla GlobalIndexMap internamente,
            ...
            <section className="pb-8">
              ...
              <div className="rounded-3xl bg-white shadow p-3 sm:p-4 overflow-x-auto">
